...
public class GestionarProveedores extends javax.swing.JFrame {
    ...
    String user;
    public static String Proveedor_update = "";
    ...
    public GestionarProveedores() {
        ...
        setSize(630, 330);
        setTitle("Proveedores registrados - Sesión de " + user);
        setResizable(false);
        ...
        try {
            ...
            jTable_proveedor = new JTable(model);
        ...
        jTable_proveedor.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (fila_point > -1) {
                    Proveedor_update = (String) model.getValueAt(fila_point, columna_point);
                    InformacionProveedores informacion_proveedor = new InformacionProveedores();
                    informacion_proveedor.setVisible(true);
                }
    ...
    private void initComponents() {
        ...
        jLabel_titulo.setText("Proveedores registrados");
        ...
        jLabel_ayuda.setText("Para editar o modificar cualquier proveedor, hacer click en cualquier nombre");
