 ...
 * @author Javier Toro
 */
public class GestionarJuguetes extends javax.swing.JFrame {
    
    String user;
    public static String juguete_update = "";
    DefaultTableModel model = new DefaultTableModel();

    /**
     * Creates new form GestionarUsuarios
     */
    public GestionarJuguetes() {
        initComponents();
        user = Login.user;
        
        setSize(630, 330);
        setTitle("Juguetes registrados - Sesión de " + user);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jTable_juguetes = new javax.swing.JTable();
        ...
        jLabel_Titulo.setText("Juguetes registrados");
        getContentPane().add(jLabel_Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, -1, -1));

        jTable_juguetes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jLabel1.setText("Para editar o modificar cualquier juguete, hacer click en cualquier nombre");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionarJuguetes().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable_juguetes;
