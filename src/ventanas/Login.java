...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        //Metodo para colocar la imegen de fondo (verde Degrade)
        ImageIcon wallpaper = new ImageIcon("src/images/wallpaperPrincipal.jpg");
        Icon icono = new ImageIcon(wallpaper.getImage().getScaledInstance(jLabel_Wallpaper.getWidth(),
                jLabel_Wallpaper.getHeight(), Image.SCALE_DEFAULT));
        jLabel_Wallpaper.setIcon(icono);

        this.repaint(); //esta linea de codigo es para refrescar el codigo 15:57 #52

        ImageIcon wallapper_logo = new ImageIcon("src/images/log_paginas.png");
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 350, 210, -1));
        ...
        getContentPane().add(jButton_Acceder, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 450, 210, 35));
        ...
        jLabel3.setText("Abrir primero base de datos (XAMPP)");
    ...
    private void jButton_AccederActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AccederActionPerformed
        ...
        if (!user.equals("") || !pass.equals("")) {
            ...
            try {
                Connection cn = Conexion.conectar(); //llamado a la clase conexcion
