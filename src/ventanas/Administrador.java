...
public class Administrador extends javax.swing.JFrame {
    ...
    public Administrador() {
        initComponents();   
        user = Login.user;   //recuperamos la variable desde la interface Login
        sesion_usuario = 1;
    ...
    private void initComponents() {
        ...
        jButton_Precios = new javax.swing.JButton();
        ...
        getContentPane().add(jButton_AcercaDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 210, 120, 100));
        ...
        jLabel7.setText("Creado por la Javier Toro");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 370, -1, -1));

        jButton_Precios.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/informationuser.png"))); // NOI18N
        jButton_Precios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_PreciosActionPerformed(evt);
            }
        });
        getContentPane().add(jButton_Precios, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 70, 120, 100));

        jLabelPrecios.setText("Gestionar Precios");
        getContentPane().add(jLabelPrecios, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 170, -1, -1));
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 410));
    ...
    private void jButton_PreciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PreciosActionPerformed
         GestionarPrecios gestionarprecios = new GestionarPrecios();
        gestionarprecios.setVisible(true);
    }//GEN-LAST:event_jButton_PreciosActionPerformed
    ...
    private javax.swing.JButton jButton_Precios;
