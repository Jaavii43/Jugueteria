...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Permisos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, -1, -1));
        ...
        getContentPane().add(jLabel_Estatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 170, -1, -1));
        ...
        getContentPane().add(txt_RegistradoPor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 210, -1));

        cmb_estatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Activo", "Inactivo" }));
        getContentPane().add(cmb_estatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 190, -1, -1));
        ...
        getContentPane().add(jButton_Actualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 260, 210, 35));
        ...
        getContentPane().add(jButton_RestaurarPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 260, 210, 35));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        String nombre, username, permisos_string = "", estatus_string = "";
        ...
        if (validacion == 0) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    "update usuarios set nombre_usuario=?, username=?, tipo_nivel=?, status=? "
                            + "where id_usuario = '" + ID + "'");
                    
                    pst2.setString(1, nombre);                                 
                    pst2.setString(2, username);
                    pst2.setString(3, permisos_string);
                    pst2.setString(4, estatus_string);
